...
namespace esspocketORM
{
    ...
    public class Region
    {
        ...
        public IEnumerable<Region> GetAll(EsspocketDBContext e)
        {
        ...
        public Region GetRegionById(EsspocketDBContext e, string id)
        {
        ...
        public Region GetRegionByName(EsspocketDBContext e, string name)
        {
            var query = (from c in e.Regions
