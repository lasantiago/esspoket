namespace esspocketORM.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<esspocketORM.EsspocketDBContext>
    {
        ...
        protected override void Seed(esspocketORM.EsspocketDBContext context)
        {
            ...
            var accountypes = new List<AccountType>
            {
                new AccountType{AccountTypeId = new Guid("55100b97-1e09-450a-abcb-cd64d8162181"), AccountTypeName = Localization.es_DO.AccountTypeNameBusiness, DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid},
                new AccountType{AccountTypeId = new Guid("0342c994-7f6c-4702-8252-809ab258ef88"), AccountTypeName = Localization.es_DO.AccountTypeNamePersonal, DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid}
            };

            // Adds all base users to the context 
            accountypes.ForEach(acc => context.AccountTypes.AddOrUpdate(acco => acco.AccountTypeName, acc));
            ...
            {
                new Gender{GenderId = new Guid("e1e89628-5619-057f-8fc3-5256d5eba647"), GenderName = Localization.es_DO.GenderMasculine, DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid},
                new Gender{GenderId = new Guid("b18c1ecb-eb97-4616-a1ec-a22c3b1fad33"), GenderName = Localization.es_DO.GenderFemenine, DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid} 
            };

            // Adds all base genders to the context 
            genders.ForEach(gen => context.Genders.AddOrUpdate(gend => gend.GenderName, gen));
            ...
            {
                new Language{LanguageId = new Guid("7a0e6555-72d2-4c90-8933-4f7ee01cd2ac"), LanguageName = Localization.es_DO.Spanish, ISO6391 = "es_DO",DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid} 
            };

            // Adds all base genders to the context 
            languages.ForEach(lan => context.Languages.AddOrUpdate(lang => lang.LanguageName, lan));
            ...
            {
                new Account{
                    AccountId = new Guid("484ea81e-def5-42ea-b98a-88ed18ecc004"), 
                    FirstName = "Ezequías", 
                    LastName = "Santos", 
                    PersonalDocumentId = "000-1111111-2",
                    DateOfBirth = dateentered,
                    AccountTypeId =  new AccountType().GetAccountTypeByName(context, Localization.es_DO.AccountTypeNamePersonal).AccountTypeId,
                    GenderId = new Gender().GetGenderByName(context, Localization.es_DO.GenderMasculine).GenderId,
                    BusinessName = "R24",
                    BusinessAccountId = new Guid("168e3a0a-19c0-4043-831c-57a29783e976"),
                    LanguageId = new Language().GetLanguageByName(context, Localization.es_DO.Spanish).LanguageId,
            ...
            // Adds all base genders to the context 
            accounts.ForEach(acc => context.Accounts.AddOrUpdate(acco => acco.AccountId, acc));
            ...
            #region TransactionStates

            var transactionstates = new List<TransactionState>
            {
                new TransactionState{TransactionStateId = 1, TransactionStateName = "Unsigned", DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid},
                new TransactionState{TransactionStateId = 2, TransactionStateName = "Signed", DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid},
                new TransactionState{TransactionStateId = 3, TransactionStateName = "Submitted", DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid},
                new TransactionState{TransactionStateId = 4, TransactionStateName = "Confirmed", DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid},
                new TransactionState{TransactionStateId = 5, TransactionStateName = "Errored", DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid},
                new TransactionState{TransactionStateId = 6, TransactionStateName = "Aborted", DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid}    
            };

            // Adds all base genders to the context 
            transactionstates.ForEach(tr => context.TransactionStates.AddOrUpdate(tran => tran.TransactionStateName, tr));
            ...
            {
                new TransactionType{TransactionTypeId = 1, TransactionTypeName = "Debit", DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid},
                new TransactionType{TransactionTypeId = 2, TransactionTypeName = "Credit", DateEntered = dateentered, DateModified = DateTime.Now, CreatedByUserId = createdbyuserid, ModifiedByUserId = modifiedbyuserid, AssignedToUserId = createdbyuserid}
            };

            // Adds all base genders to the context 
            transactiontypes.ForEach(tr => context.TransactionTypes.AddOrUpdate(tran => tran.TransactionTypeName, tr));
